...
def add(x: torch.Tensor, y: torch.Tensor):
    ...
    with open("/tmp/cubin.o", "wb") as f:
        f.write(compiled_kernel.asm["cubin"])
        os.system('readelf -a /tmp/cubin.o')
...
if __name__ == "__main__":
    ...
    a = torch.rand(512, device=DEVICE, dtype=torch.float16)
    b = torch.rand(512, device=DEVICE, dtype=torch.float16)
